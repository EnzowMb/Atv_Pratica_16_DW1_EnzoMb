      ...
      <div class="col-md-7 col-lg-8">
        ...
        <form id="formulario" class="needs-validation" action="<%= request.getContextPath() %>/registerUsuario" method="post">
          ...
          <div class="col-12">
              ...
              <input type="text" class="form-control" id="name" name="nome" placeholder="Nome" required maxLenght="70">
            </div>

            <div class="col-12">
              <label for="username" class="form-label">Username</label>
              <div class="input-group has-validation">
                <input type="text" class="form-control" id="username" placeholder="Login" name="login" required maxLenght="70">
              </div>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="input-group has-validation">
                <span class="input-group-text">@</span>
                <input type="email" class="form-control" id="email" placeholder="voce@exemplo.com" name="email" required maxLenght="70">
              </div>
            </div>
