...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="flex-shrink-0 dropdown">
          ...
          <ul class="dropdown-menu text-small shadow">
            <li><a class="dropdown-item" href="/Atv_Pratica16_EnzoMb_DW1/logout">Logout</a></li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="/Atv_Pratica16_EnzoMb_DW1/mostraTarefa?id_tarefa=<%= tarefa.getId_tarefa() %>&nome_usuario=${nome_usuario}"><button type="button" class="btn btn-sm btn-outline-secondary">Editar</button></a>
                  <a href="/Atv_Pratica16_EnzoMb_DW1/removeTarefa?id_tarefa=<%= tarefa.getId_tarefa() %>&id_usuario=${ id_usuario }&nome_usuario=${nome_usuario}"><button type="button" class="btn btn-sm btn-outline-secondary">Remover</button></a>
                </div>
  ...
  %>
  		...
  		<div align="center">
		<a href="/Atv_Pratica16_EnzoMb_DW1/registerTarefa?id_usuario=${ id_usuario }&nome_usuario=${nome_usuario}"><button type="button" class="btn btn-sm btn-outline-secondary" style="font-size: 50px; text-decoration: none; border-radius: 30%;">+</button></a>
		<br>
		Usuario: ${ id_usuario }
	</div>
    </div>
